...
Sie waren nicht nur die Adressaten der *Revue générale de l’architecture
...
Villa Rotonda Andrea Palladios.[^40] Als Ellipse ausgeführt wurde auch
...
zum Deklamieren verleitet, der ihn aber niemals die religiösen und
...
![Abb. 9: Kosmologisch-enzyklopädisches Diagramm mit
...
Galerien[^70] Bücher, Antiken und Münzen untergebracht. Nur im Sommer
...
![Abb. 11: Entwurf eines Bibliotheksneubaus für die
...
Delessert hat diese Quelle nicht genannt.[^78] Als Vorbild seiner
...
[^10]: Wenn auch in einigen Bibliotheksneubauten aus der ersten Hälfte
    ...
    und Bücherverwahrung vorgenommen wurde, dann bleiben gerade die für
    die Buchbestände vorgesehenen Räume konzeptionell der Saalbibliothek
    verbunden, insofern die Bücher nach wie vor in Büchergalerien
    entlang der Wände untergebracht wurden. Die in der zweiten Hälfte
    des 19. Jahrhunderts sich durchsetzende moderne Magazinbibliothek
    als raumökonomische Weiterentwicklung des sogenannten *stall system*
    wurde offensichtlich lediglich vorweggenommen durch die
    Hofbibliothek in Karlsruhe, 1765, die über Laborde Einzug in die
    ...
    für Berlin, 1835. Zum Bibliotheksbau des 19. Jahrhunderts vgl. im
    Überblick Hanns Michael Crass, *Bibliotheksbauten des 19.
    Jahrhunderts in Deutschland*, München 1976; Jean Bleton, "Les
    bâtiments", in: *Histoire des bibliothèques françaises*, tome 3:
    "Les bibliothèques de la Révolution et du XIXe siècle, 1789-1914",
    hg. v. Dominique Varry, Paris 1991, S. 182-237.
...
[^15]: Daraus resultierten im Entwurf Büchersammlungen, die sich im
    ersten Stockwerk von Gebäuden befanden, Beamtenwohnungen, die aus
    ...
    schließlich an den beiden Längsseiten der Büchersäle vorhandene,
...
[^22]: Zu diesem Aspekt der Bewegung in Bibliotheken vgl. exemplarisch
    Ulrich Johannes Schneider, "Bücher und Bewegung in der Bibliothek
    von Herzog August", in: Frank Büttner, Markus Friedrich u. Helmut
    Zedelmaier (Hg.), *Sammeln, Ordnen, Veranschaulichen. Zur
    Wissenskompilatorik in der Frühen Neuzeit*, Münster 2003, S.
    111-127.
...
[^31]: Boullée, Architektur, S. 119. Nach Rosenau soll sich Boullée hier
    ...
    Buch 7.xxx, beziehen, in dem Plinius über die erste von Gaius
    Asinius Pollio im Atrium Libertatis gegründete öffentliche
...
[^59]: Wie aus der das Tableau erläuternden Schrift, *Explication du
    ...
    *Bibliothèque nationale* mit der Signatur GE D-13633 nach dem Sturm
    ...
    wurde durch den Schriftzug "au Génie de la Liberté".
...
[^75]: In seinem zweiten Bibliotheksentwurf von 1838, bei dem er die
    "forme panoptique" an die *Place de Bellechasse* als neudiskutierten
    Standort der Bibliothek anpasst, indem er den Rundbau zu einem
    ummantelten Oval werden lässt, sieht Delessert hingegen Oberlicht
    vor. Vgl. Benjamin Delessert, *Second mémoire sur la Bibliothèque
...
[^79]: Hintergrund von Baltards Entwurf waren zwei von der Regierung
    ...
    offensichtlich auch andere Rundbauten entworfen wurden. Mauduits und
...
[^84]: Edwards schreibt: "Many years ago, the late M. Benjamin
    ...
    1859, S. 712. Während Jean-François Foucaud lapidar feststellt, dass
    Delessert Bentham gelesen hat. Jean-François Foucaud, "Extensions et
    travaux de la Bibliothèque nationale", in: *Histoire de les
    Bibliothèques francaises*, tome 3: "Les bibliothèques de la
