...
Möglichkeiten wie etwa das Importieren von bibliographischen Metadaten
...
import, search, export) mit Beispielen}
\end{figure}
...
``*Zauberstab``*, Importfunktion von anderen Formate). In den meisten
großen Aufsatzdatenbanken wie JSTOR oder EBSCO ist Mehrfachübernahme,
das heißt alle Aufsätze eines Zeitschriftenheftes mit einem Klick,
möglich.
