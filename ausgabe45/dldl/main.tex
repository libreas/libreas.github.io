...
\href{https://doi.org/10.18452/29145}{\color{black}https://doi.org/10.18452/29145}
{}} % doi 
...
\hypersetup{%
      ...
      pdflang={de},
      pdfmetalang={de},
      pdfdoi={10.18452/29145},
      pdfurl={https://doi.org/10.18452/29145}
     }
...
für \enquote{Fachreferent:innen und umzu}, denkt man. Und rollt dann bei
einigen der (sehr kurzen) Beiträge angesichts der recht \enquote{heroischen}
Darstellungen ein wenig mit den Augen.

Die angesprochenen Themenbereiche und vor allem die zu jedem Beitrag
aufgeführten \enquote{Discussion questions} können aber für das Nachdenken über
die Lage an deutschen Bibliotheken durchaus \enquote{Knabberzeug} liefern. (vv)
...
Von einem Buch mit dem Titel \enquote{The marketing of academic, national and
...
Fragen, schwanken sie oft zwischen Marketing \enquote{für Bibliotheken} und \enquote{für
die jeweiligen Bibliothekar:innen} (bis hin zu \enquote{What would you like to
...
Beispiel \enquote{as I am not the marketing expert, I can't
...
\enquote{Entanglement} von Bibliotheken und Geschichte geeignet, um den Inhalt
...
plädiert dafür, besser für Strukturen zu sorgen, damit \enquote{antiquierte}
...
\href{https://sharefrome.org/}{https://sharefrome.org/}. (bk)
...
\enquote{vielleicht nicht jeder Gentleman möchte, dass es jeder sieht}. Auf
...
Zenthöfer, Jochen (2024). \emph{\enquote{Für die Nut­zung dau­er­haft gesperrt}:
