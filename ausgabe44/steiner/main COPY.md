...
des/der Vertreter\*in von Institutionen in den Vordergrund tritt.
...
diese wurden im digitalen Raum plötzlich möglich.
...
and Theater Research beheimatete scholar-led Initiative, die historische
...
2016 startete das Webportal [Open Access in Media
...
Futures](https://doi.org/10.21428/785a6451.39b2b1ea)
...
Adema, Janneke. 2021a. *Living Books: Experiments in the
...
Hall, Gary. 2016. *Pirate Philosophy for a Digital Posthumanities*.
...
Kiesewetter, Rebekka. 2020. 'Undoing Scholarship: Towards an Activist
...
Olleros, F. Xavier. 2018. 'Antirival Goods, Network Effects and the
...
Treloar, Andrew. 1996. 'Better than Print? Hypermedia Scholarly
...
[^6]: Gary Hall: *Digitize This Book!: The Politics of New Media, or Why
    We Need Open Access Now*, Minneapolis 2008 (Electronic Mediations
    24). 105  ff. Siehe hier auch Halls Ausarbeitung von
    Charakteristiken unterschiedlicher Open Access-Lesarten, die er in
    "liberal, democratising", "renewed public sphere", und "gift
    economy" -Ansätze unterteilt. Ebenda 108 ff.

[^7]: Siehe beispielsweise den europäischen Fokus auf die
    empirisch-quantitativ orientierte \'Open Science\' sowohl auf
    Förder- als auch auf Policy-Ebene ([European
    Commission](https://ec.europa.eu/info/research-and-innovation/strategy/strategy-2020-2024/our-digital-future/open-science_en),
    Horizon Europe, [Plan S & Coalition
    S](https://www.coalition-s.org/)), als auch nationale
    Bestrebungen wie das deutsche [Projekt
    DEAL](https://www.projekt-deal.de/), oder der
    niederländische [National Plan Open
    Science](https://www.openscience.nl/en), sowie der
    französische [Second National Plan Open
    Science](https://www.ouvrirlascience.fr/second-national-plan-for-open-science/).
    Zahlreiche Stimmen aus den Geistes- und Sozialwissenschaften
    kritisieren mittlerweile deren einseitige Orientierung an
    medizinisch-naturwissenschaftlichen Publikationskulturen sowie der
    damit einhergehenden Fortschreibung des etablierten
    neoliberal-marktökonomischen Publikationssystems ([Eve
    2013](https://eve.gd/2013/03/10/open-access-neoliberalism-impact-and-the-privatisation-of-knowledge/),
    [Aguado-López & Becerill-Garcia
    2019](https://blogs.lse.ac.uk/impactofsocialsciences/2019/08/08/amelica-before-plan-s-the-latin-american-initiative-to-develop-a-cooperative-non-commercial-academic-led-system-of-scholarly-communication/),
    [Kember
    2014](https://adanewmedia.org/2014/04/issue4-kember/),
    [Kamerlin et al.
    2021](https://doi.org/10.1111/dech.12635), [Moore
    2021](https://doi.org/10.1111/dech.12640),
    [Knöchelmann 2021](https://osf.io/hw7at), [Cabrerizo
    2022](https://www.nature.com/articles/d41586-022-01414-7)).

[^8]: \"possibilities \[of preprints\] remain largely unexplored in the
    humanities.\" ([Laporte
    2016](https://doi.org/10.31235/osf.io/jebhy))

[^9]: \"\[\...\] the humanities are a dominated 'other' to the
    ideal-typical research and publication practices of other scientific
    domains. It is therefore not surprising that bibliometricians have
    not been met with a lot of enthusiasm amongst humanities scholars
    (e.g. Dehue, 2000; Kiefer, 2014). There is indeed little reason to
    be supportive of bibliometric efforts from a humanities
    perspective.\" ([Franssen & Wouters,
    2017](https://doi.org/10.48550/arXiv.1710.04004), S.
    18)

[^10]: Siehe hierzu einführend beispielsweise Arianna Becerril-García,
    Eduardo Aguado-López: [The End of a Centralized Open Access Project
    and the Beginning of a Community-Based Sustainable Infrastructure
    for Latin America: Redalyc.org after Fifteen Years The Open Access
    ecosystem in Latin
    America](https://dx.doi.org/10.4000/proceedings.elpub.2018.27),
    2018, sowie Reggie Raju, Jill Claassen: [Open Access: From Hope to
    Betrayal](https://doi.org/10.5860/crln.83.4.161), in:
    *College & Research Libraries News*, Bd. 83, Nr. 4, 2022, S. 161.

[^11]: Für eine weitergehende Diskussion der Frage, wieso die Adaption
    von Open Access in den Geistes- und Sozialwissenschaften gefühlt so
    schleppend verläuft, siehe beispielsweise auch Adema and Hall: [The
    Political Nature of the Book: On Artists' Books and Radical Open
    Access](https://pureportal.coventry.ac.uk/en/publications/the-political-nature-of-the-book-on-artists-books-and-radical-ope-2),
    in: *New Formations*, Bd. 78, Nr. 1, 2013, S. 138--156.

[^12]: "For Okerson, journal publishing was in a 'dismal' state with
    over 71 % of journals published by the for-profit sector, which
    resulted in a 'loss of ownership' of scholarly publishing from the
    academy." Ann Okerson, 1992, zitiert in [Moore, 2020
    \[2019\], S. 8](https://doi.org/10.17613/41h8-j423).

[^13]: Hier mit Bezug auf die Tradition von *scholar-led* in den
    Geistes- und Sozialwissenschaften, in leicht abgewandelter Anlehnung
    an den Eröffnungssatz der Erklärung der Budapest Open Access
    Initiative (BOAI), "An old tradition and a new technology have
    converged to make possible an unprecedented public good.", siehe
    [https://www.budapestopenaccessinitiative.org/read/](https://www.budapestopenaccessinitiative.org/read/).

[^14]: Im Sinne von "fundamental", die Wurzel betreffend.

[^15]: Andrew Treloar beschreibt in seinem 1995 veröffentlichten Aufsatz
    "[Better than Print? Hypermedia Scholarly Publishing and the World
    Wide
    Web](https://andrew.treloar.net/research/publications/vala96/index.html)"
    die Vorgehensweise bezüglich (A)FTP, Listserv und anderer Protokolle
    im Detail.

[^16]:  Hier sind beispielsweise Layouting, digitales publishing via CMS
    (Drupal, WordPress, OJS, et cetera) und Print-on-Demand publishing
    zu nennen. Siehe dazu auch Janneke Adema: [Where Open Philosophy
    Meets Open
    Music](https://openreflections.wordpress.com/2009/06/23/where-open-philosophy-meets-open-music/),
    *OPEN REFLECTIONS*, 23.6.2009; und Silvio Lorusso: [Interview with
    Paul Ashton, co-founder of
    re.press](https://networkcultures.org/outofink/2011/09/13/interview-with-paul-ashton-co-founder-of-re-press/),
    *Out of Ink \| Future of the Publishing Industry*, 13.9.2011.
...
[^18]: Hier muss der Vollständigkeit halber ergänzt werden, dass weitere
    frühe Beispiele aus der deutschsprachigen Medienwissenschaft wie
    beispielsweise *MEDIENwissenschaft Rezensionen \| Reviews* (1984),
    *AugenBlick. Konstanzer Hefte zur Medienwissenschaft* (1985) oder
    *montage AV* (1992) für diese Übersicht initial auch in Betracht
    gezogen wurden -- da sie in Zusammenarbeit mit dem Schüren Verlag
    herausgegeben werden, fallen sie jedoch nicht in die engere Auswahl,
    da die externalisierte verlegerische Tätigkeit nicht unter die
    Definition selbstorganisierter scholar-led-Initiativen (siehe
    definitorischer Teil dieses Beitrags) fällt.

[^19]: Siehe dazu auch die [Abbildungen in Dene Grigars Rebooting
    Electronic
    Literature](https://scalar.usc.edu/works/rebooting-electronic-literature/photos-of-david-kolbs-socrates-in-the-labyrinth),
    2018.

[^20]: Siehe dazu auch William Mitchells die eigene Praxis
    reflektierenden Aufsatz [Homer to Home-Page: Designing Digital
    Books](http://mitpress2.mit.edu/e-books/City_of_Bits/Text_Unbound/text_unbound.html),
    Februar 1996.

[^21]: Als Anekdote scheint mir hier bemerkenswert, dass Eric Eldred
    eine [eigene Public-Domain-Lizenz für Eldritch Press unter dem
    Label "Eldred PD" gewidmet
    wurde](https://web.archive.org/web/20030115160926/http://www.creativecommons.org/licenses/eldred-pd).

[^22]: Wie schon zuvor im Text ist 'radikal'› hier in der Konnotation
    von 'grundsätzlich', 'die Wurzel betreffend' zu verstehen.

[^23]: Siehe beispielsweise Joe Deville: [Open Access Publishing and
    the Future of the
    University](https://www.matteringpress.org/blog/open-access-publishing-and-the-future-of-the-university)
    oder Janneke Adema und Samuel A. Moore: [Collectivity and
    Collaboration: Imagining New Forms of Communality to Create
    Resilience in Scholar-Led
    Publishing](https://doi.org/10.1629/uksg.399).

[^24]: Siehe hierzu auch das empfehlenswerte [Interview mit Mercedes
    Bunz](https://jussiparikka.net/2014/07/11/a-mini-interview-mercedes-bunz-explains-meson-press/),
    Mitbegründerin von meson press, geführt von Jussi Parikka.

[^25]: Für eine Übersicht aktueller experimenteller
    Buchpublikationspraktiken, dazu geeigneter Open-Source-Plattformen
    sowie Beispielpublikationen siehe beispielsweise der im
    COPIM-Projekt entstandene Scoping Report [Books Contain Multitudes:
    Exploring Experimental Publishing (2022
    update)](https://doi.org/10.21428/785a6451.1792b84f)
    sowie das jüngst veröffentlichte [Experimental Publishing
    Compendium](https://compendium.copim.ac.uk).

[^26]: Siehe zu "non-rivalrous goods" im Open-Access-Kontext
    beispielsweise [Suber
    2016](https://knowledgeunbound.mitpress.mit.edu/pub/cjktrtqe/release/1)
    oder [Olleros
    2018](https://doi.org/10.5210/fm.v23i2.8161).

[^27]: Für Näheres zum Thema Wissensallmende beziehungsweise *Knowledge
    Commons* siehe beispielsweise das von David Bollier geführte
    Podcast-Interview mit Sam Moore "[The Radical Open Access
    Collective: Building Better Knowledge
    Commons](http://www.bollier.org/blog/radical-open-access-collective-building-better-knowledge-commons,)",
    oder weiterführend [Adema & Moore
    2018](http://doi.org/10.1629/uksg.399) sowie [Moore
    2019](https://doi.org/10.17613/st5m-cx33).

[^28]: Vergleiche beispielsweise Deville et al.
    [2019](https://doi.org/10.18352/lq.10277), oder für
    den DACH-Kontext der [LIBREAS-Beitrag von Kathrin Ganz, Marcel
    Wrzesinski und Markus
    Rauchecker](https://doi.org/10.18452/21418).

[^29]: Oder eben auch föderierte Meta-Communities beispielsweise auf
    nationaler Ebene, wie im Fall von
    [journal.fi](https://journal.fi/).

[^30]: Siehe dazu auch Audrey Watters: ["Commons in a Box" \& the Importance of Open Academic
    Networks](https://www.insidehighered.com/blogs/hack-higher-education/commons-box-importance-open-academic-networks),
    *Inside Higher Ed*, 28.11.2011.

[^31]: Zur *working theory* des Gründungstrios siehe Eric Hoyt, Wendy
    Hagenmaier, Carl Hagenmaier: [Media + History + Digital + Library:
    An Experiment in
    Synthesis](https://dx.doi.org/10.1349/PS1.1938-6060.A.430),
    in: *Journal of E-Media Studies*, Bd. 3, Nr. 1, 2013.

[^32]: Für weiterführende Details zum ROAC, siehe beispielsweise [Adema
    & Moore 2017](http://doi.org/10.1629/uksg.399) oder
    [Masterman 2020](https://doi.org/10.17613/t5n3-x550).

[^33]: Gründungsmitglieder von ScholarLed waren [Mattering
    Press](https://www.matteringpress.org), [meson
    press](https://meson.press), [Open Book
    Publishers](https://www.openbookpublishers.com),
    [punctum books](https://punctumbooks.com), und [Open
    Humanities Press](http://www.openhumanitiespress.org/).
    In 2021 kamen [African
    Minds](https://www.africanminds.co.za/) und
    [mediastudies.press](https://www.mediastudies.press/)
    hinzu.

[^34]: Siehe
    [https://scholarled.org](https://scholarled.org),
    sowie weitere Details im von Eelco Ferwerda geführten Interview
    "Scaling Small: The Story behind ScholarLed", [Part
    1](https://oapen.hypotheses.org/93), [Part
    2](https://oapen.hypotheses.org/99).

[^35]: Siehe dazu auch
    [https://copim.pubpub.org](https://copim.pubpub.org)
    sowie die Übersichtspräsentationen "[Open Access-Bücher, und eine
    kurze Einführung zu
    COPIM](https://doi.org/10.5281/zenodo.6343819)" und
    "[Making Open Access Books Work Fairly: establishing collaboration
    between libraries, publishers, and infrastructure
    providers](https://copim.pubpub.org/pub/rluk22-making-open-access-books-work-fairly-establishing-collaboration-between-libraries-publishers-and-infrastructure-providers/release/1?readingCollection=6c638086)".
