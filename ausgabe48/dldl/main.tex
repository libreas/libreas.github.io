...
\emph{Bibliothèque(s) : revue de l'Association des bibliothécaires
français (ABF)}. (2025) 104
...
Beschreibungen ("research skills", "find, evaluate, and use information"
sowie "critical information use"), welche ebenso oft genutzt werden,
...
befinden -- wird der Begriff "Information Literacy" viel weniger genutzt
...
"Bibliothek" eine sehr spezifische Einrichtungen gemeint, die sich sonst
...
Eindruck vermittelt, dass hier "Museumsleute" eine Einrichtung aufgebaut
haben, die vor allem "kein Archiv" und "kein Museum" sein soll -- und
deshalb "Bibliothek" genannt wird. (ks)
...
über die herausgebenden Körperschaften, die "OA-Farbe", Angaben zu Open
...
werden Open-Access-Publikationen in "hybriden" Zeitschriften, die sowohl
Open als auch Closed Access veröffentlichen, mehr und schneller zitiert
als solche, die in "reinen" Open Access Journals veröffentlicht werden.
...
eine amerikanische "Herkunft". Das macht direkte Vergleiche mit der Lage
...
diesem Band, nach eigenen Aussagen "the first academic volume to examine
...
Artikel zur Reihe "xkcd" Abbildungen von Beispielen besprochener Comics
...
sagen, was auch nicht so richtig nach "Zukunft" klingt.) Forecasts sind
...
\hypertarget{diversity-und-bestandsmanagement}{%
...
Clavien, Alain (2025). \emph{L'argent de la presse suisse: les années
...
Seglins, Dave (2026). \emph{Getting access to RCMP 'Native extremism'
files took 4-year fight}. CBC Investigates,
...
St-Pierre, Sarah (2026). \emph{Apology 'not enough': Dene leaders want
to see the RCMP spying files.} CBC North,
