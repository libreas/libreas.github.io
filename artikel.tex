...
\usepackage{booktabs} 
\usepackage[left=2.4cm,right=2.0cm,top=2.3cm,bottom=2cm,includeheadfoot]{geometry}
\usepackage{eurosym}
\usepackage{multirow}
...
\fancyhead[L]{LIBREAS. Library Ideas 24}
\fancyhead[R]{\href{http://nbn-resolving.de/urn:nbn:de:kobv:11-100212657}{urn:nbn:de:kobv:11-100212657}}
\fancyfoot[L]{Creative Commons 3.0: BY}
